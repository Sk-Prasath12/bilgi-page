...
const toggleMenu = () => setMenuOpen(!menuOpen);
    ...
    return (
      ...
      <nav className="flex justify-between items-center px-6 md:px-10 py-5 relative">
        ...
        {/* Mobile Menu */}
        <div
          className={`absolute top-0 left-0 w-full bg-red-500 transition-transform duration-300 ease-in-out ${
        ...
        >
          <ul className="items-center font-medium">
            ...
            <li>Kurumsal</li>
            <li>
              <button className="bg-black text-red-600 px-4 py-2 rounded-md">
                İletişim
              </button>
            </li>
          </ul>
          ...
          <div className="flex items-center space-x-4">
            ...
            <section className="contact-section">
                <div className="icon-wrapper">
                    <div className="circle outlined"></div>
