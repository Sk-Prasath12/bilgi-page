  ...
  return (
    <>
      <header className="header bg-gray-900 text-black">
        <nav className="flex justify-between items-center px-10 md:px-30 py-8 relative">
          {/* Logo or Brand */}
          {/* <div className="text-xl font-bold">Logo</div> */}

          {/* Desktop Menu */}
          <ul className="hidden md:flex space-x-10 font-medium">
            <li className="hover:text-red-400 cursor-pointer">Çözümler ve Hizmetler</li>
            <li className="hover:text-red-400 cursor-pointer">Ürünler</li>
            <li className="hover:text-red-400 cursor-pointer">Teknolojiler</li>
            <li className="hover:text-red-400 cursor-pointer">İnsan Kaynakları</li>
            <li className="hover:text-red-400 cursor-pointer">Kurumsal</li>
          </ul>

          {/* Contact Button (Desktop) */}
          <button className="hidden md:block bg-red-500 text-white px-8 py-2 rounded-md hover:bg-red-600 transition">
            İletişim
          </button>
          ...
          >
            <ul className="flex flex-col items-center space-y-6">
              ...
              <li>
                <button className="bg-black text-red-500 px-6 py-3 rounded-md hover:bg-gray-800 transition">
                  İletişim
                </button>
              </li>
            </ul>
        ...
        {/* Hero Section */}
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-7xl mx-auto px-9 py-10">
          <div className="ml-[-85px] text-left mt-[-180px]">
     ...
     <section>
        <div className="max-w-7xl mx-auto px-9 py-20">
          <div  className="second">
            <h2 className="text-2xl font-bold mb-10">Kalite ve Süreç Yönetimi</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6 bg-white rounded-lg">
              <div className="relative flex items-center justify-center mb-6">
                <div className="absolute right-[35%] w-8 h-8 rounded-full bg-pink-500" />
                <IoDocumentOutline className="text-3xl text-black relative z-10" />
              </div>
            ...
            <div className="text-center p-6 bg-white rounded-lg ">
              <div className="relative flex items-center justify-center mb-6">
                <div className="absolute right-[50%] w-8 h-8 rounded-full bg-violet-400" />
                <IoIosStarOutline className="text-3xl text-black relative z-10" />
              </div>
            ...
            <div className="text-center p-6 bg-white rounded-lg ">
              <div className="relative flex items-center justify-center mb-6">
                <div className="absolute right-[34%] w-8 h-8 rounded-full bg-sky-400" />
                <LuCrown className="text-3xl text-black relative z-10" />
              </div>
            ...
            <div className="text-center p-6 bg-white rounded-lg ">
              <div className="relative flex items-center justify-center mb-6">
                <div className="absolute right-[50%] w-8 h-8 rounded-full bg-blue-400" />
                <PiChartBar className="text-3xl text-black relative z-10" />
              </div>
            ...
            <div className="text-center p-6 bg-white rounded-lg ">
              <div className="relative flex items-center justify-center mb-6">
                <div className="absolute right-[34%] w-8 h-8 rounded-full bg-red-500" />
                <PiChartPieThin className="text-3xl text-black relative z-10" />
              </div>
            ...
            <div className="text-center p-6 bg-white rounded-lg ">
              <div className="relative flex items-center justify-center mb-6">
                <div className="absolute right-[35%] w-8 h-8 rounded-full bg-yellow-400" />
                <FaFigma className="text-3xl text-black relative z-10" />
              </div>
      ...
      <footer className="footer">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mt-10 border-gray-700 pt-6 px-6 md:px-20">
